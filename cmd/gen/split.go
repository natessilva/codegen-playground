...
/*
	from https://github.com/pacedotdev/oto
	The MIT License (MIT)
...
func jsonType(t string, isNumeric bool) string {
	if isNumeric {
		return "number"
	}
	if t == "bool" {
